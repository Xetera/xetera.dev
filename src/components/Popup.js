      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className={`bottom-auto items-center flex popup bg-blueGray-800 rounded absolute py-3 px-4 text-blue-100 ${className} shadow-xl md:text-base text-xs leading-normal md:max-w-lg max-w-full md:mx-auto mx-4 shadow-lg`}
            style={{
              position: "fixed",
              bottom: "0",
              left: "0",
