      ...
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className={`bottom-auto items-center flex popup bg-blueGray-600 rounded absolute py-3 px-4 text-blue-100 ${className} shadow-xl md:text-sm text-xs leading-normal md:max-w-lg max-w-full md:mx-auto mx-4`}
            style={{
              position: "fixed",
              bottom: "0",
              left: "0",
