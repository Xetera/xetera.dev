...
banner:
  url: "/article-assets/misleading-educational-videos/banner.png"
  aspectRatio: "1:1"
---
...
![a screenshot of JWT claims showing multiple fields that could be considered sensitive](/article-assets/misleading-educational-videos/jwt_dump.png)
...
![Youtube comment: "This is more of [a] tutorial about how to not use JWT"](/article-assets/misleading-educational-videos/jwt_comment.png)

![Youtube comment: "JWT tokens should be used by the user, it's just that the tokens should never include data that is private"](/article-assets/misleading-educational-videos/jwt_comment_2.png)
...
![Experienced security person ripping into the flaws of the video](/article-assets/misleading-educational-videos/jwt_comment_good.png)
