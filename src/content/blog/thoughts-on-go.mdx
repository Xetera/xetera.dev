...
tags:
  ...
  - Opinion
banner:
  url: "/article-assets/thoughts-on-go/banner.png"
  aspectRatio: "2:3"
draft: true
# imageTop:
#   objectPosition: "30%"
#   src: /article-assets/thoughts-on-go/golang.jpg
---

import T from '🧱/T.astro'
import Caption from '🧱/Caption.astro'

![](/article-assets/thoughts-on-go/golang.jpg)
...
![language preference chart](/article-assets/thoughts-on-go/language-preference.png)
...
export const Gopher = () => (
  <div text="Gophers" color="blue.300">
...
![untar xkcd](/article-assets/thoughts-on-go/tar.png)
...
import openYourEyes from "/article-assets/thoughts-on-go/null_pointer.mp4"
...
![](/article-assets/thoughts-on-go/unused_variable.png)
...
![](/article-assets/thoughts-on-go/unused_variable_solution.png)
...
![](/article-assets/thoughts-on-go/type_safety.jpeg)
...
![](/article-assets/thoughts-on-go/actually_youre_wrong.png)
...
![](/article-assets/thoughts-on-go/date_formatting.png)
