...
const marcoProps = ({ marcoAvatar }) => ({
  username: "marco_rennmaus | Rennmoose2",
  roleColor: "color-red-300",
  avatar: marcoAvatar,
});

const xetProps = ({ xetAvatar }) => ({
  username: "Xetera",
  roleColor: "text-blue-300",
  avatar: xetAvatar,
});

const dracProps = ({ dracAvatar }) => ({
  username: "Drac",
  avatar: dracAvatar,
  roleColor: "text-red-400",
});

export const skyProps = ({ skyAvatar }) => ({
  username: "Sky",
  avatar: skyAvatar,
...
export const Debugging = ({
  ...
  return (
    <DiscordMessageContainer>
      ...
      />
      <DiscordMessage
        messages={["sigh", <img src={proofSky.src} />]}
        date="06/28/2021"
        {...skyProps({ skyAvatar })}
      />
      <DiscordMessage
...
export const ItWorks = ({ xetAvatar, skyAvatar }) => {
  return (
    <DiscordMessageContainer>
      <DiscordMessage
        messages={[
