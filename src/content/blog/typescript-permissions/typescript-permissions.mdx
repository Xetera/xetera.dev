...
tags:
  ...
  - Guide
seo:
  description: Building a typescript permissions system that encodes information about the permissions of users in the type system, making it impossible to forget permission checks.
---
