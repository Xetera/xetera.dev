...
tags:
  - Rant
banner: "src/assets/whatsapp-sucks/banner.png"
imageTop:
  src: /article-assets/whatsapp-sucks/whatsapp.jpg
---
...
<DiscordMessageContainer>
  ...
  <DiscordMessage
    ...
    avatar={<Whatsapp />}
    reactions={[
      { image: <Uhuh />, reactCount: 0, reacted: true, name: ":uhuh:" },
    ]}
  />
</DiscordMessageContainer>
*/}
...
<p class="mb-4 text-sm color-text-400">
...
import { WhatsappContainer, WhatsappMessage } from "../../components/messaging/whatsapp"
