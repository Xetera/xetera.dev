...
tags:
  ...
  - Guide
seo:
  description: A showcase of what working remote in Turkey is like, specifically what the process of running your own company entails like filing taxes and signing contracts.
---
...
<Callout title="2026 update" color="var(--highlight)">
  Believe it or not, there's a <b>100%</b> tax break for income earned overseas now! Some of this information in this section is now outdated. Though you still need an accountant to pay other types of taxes not tied to your income, and a separate CPA that works with the government who will audit whether you're eligibile for the tax break. However both of those a drop in the bucket compared to paying income taxes.
</Callout>
...
- You want to pay 0% in income taxes
