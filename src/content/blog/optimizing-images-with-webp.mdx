...
banner:
  url: "/article-assets/converting-webp/banner.png"
  aspectRatio: "2:3"
tags:
  - Guide
  - Bug
...
export const ExampleImage = ({ title, text, size, children, src }) => {
  return (
    <article class="flex-1 bg-body-800 min-w-[260px] font-sans">
      ...
      <div class="flex justify-between items-center px-4 py-1">
        <h3 class="text-lg md:text-xl color-text-600 m-0 font-bold">{title}</h3>
...
it either."
  />
  <ExampleImage
    src="/article-assets/converting-webp/handong.webp"
    title="😎 Chad WebP"
    size="433KB"
    text={
      <>
...
![](/article-assets/converting-webp/wtf.png)
...
![](/article-assets/converting-webp/converted.png)
...
![](/article-assets/converting-webp/tail.png)
...
![](/article-assets/converting-webp/jiu_umbrella.jpeg)
