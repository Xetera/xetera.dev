...
<Callout title="TLDR">
  I've made <ExternalLink class="inline-flex text-blue-400 underline" href="https://github.com/xetera/router-freedom">a cross-platform desktop app</ExternalLink> that can help you find the credentials if you're not interested in the technical details.
</Callout>
