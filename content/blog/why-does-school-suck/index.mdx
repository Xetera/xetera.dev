---
title: 🏫 Why does school suck?
date: "2021-07-15"
description: How do so many people who love learning hate formal education?
draft: true
tags:
  - Rant
  - Exploration
...
> So Jake, what do you want to be when you grow up?

Every teenager's worst nightmare. Of the million things you could choose as a profession, chances are you have no idea what I could be interested in growing up. We force kids to learn a common core curriculum and expect them to magically have an idea of what they could be doing for a living after high school or college.
...
The bottom line is that school does absolutely nothing to teach you about different fields you could be interested in. You will learn the things a bunch of boomers decided you should know, and you will be released into the wild with no valuable knowledge to further your career. And I don't mean valuable knowledge same way an annoying middle-schooler would talk about it in science class going:

import Kekw from "@assets/emotes/kekw.png"

> Ummm excuse me, Ms. Holloway? When are we ever going to need to know what a shield volcano is in real life <ChakraImage src={Kekw} display="inline" htmlWidth="30px" verticalAlign="top" />.

I mean that information <T>you</T> consider to be interesting is what is valuable to you. I need more than just to be able to feed myself. I need self-actual
