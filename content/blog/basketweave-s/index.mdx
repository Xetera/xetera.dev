...
This will output a `42keebs_basketweave_s_default.hex.hex` file which is the built firmware into `~/qmk_firmware` if you installed QMK into the default location.
