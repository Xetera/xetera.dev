...
This still feels a little bit weird, though. Assigning a new user variable feels unnatural, and this doesn't look like our original check either. That's ok, TypeScript gives us a way to narrow the types of variables conditionally using something called <Link href="https://basarat.gitbook.io/typescript/type-system/typeguard" target="_blank">Type Guards</Link>.
