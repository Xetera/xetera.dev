...
<WideBanner className="w-full bg-blueGray-900" noBg centered>
  <div class="py-4 justify-between items-center flex lg:flex-row flex-col rounded text-blue-200">
    <div class="flex items-center lg:mb-0 mb-0">
      <FaExclamationTriangle class="mr-3 md:text-lg mb-0" />
      <h3 class="my-0 md:text-lg sm:text-base font-black inline">Warning</h3>
    </div>
    <p class="font-black my-0 inline">Opinion Ahead</p>
  </div>
</WideBanner>
