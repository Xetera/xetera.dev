...
export const Circlejerk = () => (
  <Toastable className="text-orange-300" text="circlejerks">
    <div>
      <p className="mb-0">
        When multiple people on the internet who have a shared interest or
        ideology get together to congratulate each other for having the opinions they do.
      </p>
      <sub className="text-gray-500 m-0">
        Please just trust me on the definition and don't Google this word
      </sub>
    </div>
  </Toastable>
)
