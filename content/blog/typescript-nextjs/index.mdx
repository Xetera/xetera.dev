...
<WideBanner centered layerStyle="bgSecondary">
...
import ThisArrow from "./thisarrow.gif"
...
<DiscordMessage
  ...
  avatar={Dahyun}
  reactions={[
    { image: ThisArrow, reactCount: 7 },
    { image: ThisTbh, reactCount: 12 },
  ]}
/>

But not to worry, as of [Typescript 3.8](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-3-8.html), we can import _just_ types from a typescript file, meaning it's possible to do this:
